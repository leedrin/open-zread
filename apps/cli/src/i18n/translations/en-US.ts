...
export const enUS: TranslationKeys = {
  ...
  wikiGenerate: {
    ...
    retry: 'Regenerate',
    exit: 'Exit',
    manageShortcuts: 'a Add topic | d Delete topic | e Edit metadata | w Rewrite section',
    busyHint: 'An operation is in progress, please wait',
    addPrompt: 'Describe the new topic:',
    addRunning: 'Adding topic...',
    addSuccess: '{count} page(s) added',
    addError: 'Add failed: {error}',
    deleteConfirm: 'Delete "{title}"? This cannot be undone',
    deleteConfirmHint: 'y confirm | n/esc cancel',
    ...
    editGroupLabel: 'Group (optional, leave blank to keep unchanged):',
    editAssociatedPrompt: 'Describe the new associated code scope (optional, leave blank to skip; the agent will re-explore the code):',
    editRunning: 'Updating metadata...',
    dismissHint: 'Press any key to close',
    editSuccess: 'Page metadata updated',
    editError: 'Update failed: {error}',
    sectionRewritePrompt: 'Describe how to rewrite this section:',
    sectionRewriteRunning: 'Rewriting section...',
    sectionRewriteSuccess: 'Section rewrite complete',
    sectionRewriteError: 'Rewrite failed: {error}',
    submitHint: 'enter next | esc cancel',
  },
};